...
public class Util {
    ...
    /**
     * Epistrefei MD5(or SHA-1) hash apo string (px gia na vgaloume to hash tou
     * broker "ip:port" h to hash tou "topic") (mporoume na tin valoume se helper
     * class px utils.java)
     *
    ...
    /**
     * xwrizei to arxeio se mia lista bytes[](to megethos twn byte[] pernaei san
     * parametros)
     * 
    ...
    public ArrayList<byte[]> splitFileToChunks(File file, int chunkSize) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(file))) {
            ...
            while (line != null) {
                ...
                // FileOutputStream(newFile))) { // to ekana comment epeidi logika den xriazetai
                // na grafoume se file edw, mono se arraylist
                int fileSize = 0;
                while (line != null) {
     ...
     * @throws IOException
     */
    public File mergeChunksToFile(ArrayList<byte[]> chunks) throws IOException {
